...
function submitForm() {
  ...
  $.ajax({
    ...
    success: function (t) {
      "success" == t ? formSuccess() : (formError(),
        submitMSG(!1, t))
    }
  })
}
...
function submitMSG(t, e) {
  if (t)
    i = "h3 text-center tada animated text-success";
  else
    var i = "h3 text-center text-danger";
...
if (function (t, e) {
    ...
    function o(t, e, i) {
      ...
      }) : Et.test(e) ? ft.filter(e, t, i) : (e = ft.filter(e, t),
    ...
    function f(t, e, i) {
      ...
      if (void 0 === i && 1 === t.nodeType)
        if (n = "data-" + e.replace(Qt, "-$&").toLowerCase(),
    ...
    function y(t, e) {
      for (var i, n, r = [], o = 0, s = t.length; o < s; o++)
        (n = t[o]).style && (i = n.style.display,
          e ? ("none" === i && (r[o] = kt.get(n, "display") || null,
              r[o] || (n.style.display = "")),
            "" === n.style.display && Mt(n) && (r[o] = m(n))) : "none" !== i && (r[o] = "none",
            kt.set(n, "display", i)));
      for (o = 0; o < s; o++)
    ...
    function b(t, e, i, n, r) {
      ...
      for (h.textContent = "",
        p = 0; o = d[p++];)
        if (n && ft.inArray(o, n) > -1)
          r && r.push(o);
        else if (u = ft.contains(o.ownerDocument, o),
    ...
    function D(t, e, n, r) {
      ...
      if (d && (o = b(e, t[0].ownerDocument, !1, t, r),
        ...
        for (l = (a = ft.map(v(o, "script"), P)).length; h < d; h++)
          u = o,
          h !== p && (u = ft.clone(u, !0, !0),
            l && ft.merge(a, v(u, "script"))),
          n.call(t[h], u, h);
        if (l)
          for (c = a[a.length - 1].ownerDocument,
            ...
            h = 0; h < l; h++)
            u = a[h],
            $t.test(u.type || "") && !kt.access(u, "globalEval") && ft.contains(c, u) && (u.src ? ft._evalUrl && ft._evalUrl(u.src) : i(u.textContent.replace(ne, ""), c))
      }
      return t
    }
    ...
    function O(t, e, i) {
      for (var n, r = e ? ft.filter(e, t) : t, o = 0; null != (n = r[o]); o++)
        ...
        n.parentNode && (i && ft.contains(n.ownerDocument, n) && _(v(n, "script")),
    ...
    function j(t, e, i) {
      ...
      return (i = i || se(t)) && ("" !== (s = i.getPropertyValue(e) || i[e]) || ft.contains(t.ownerDocument, t) || (s = ft.style(t, e)), !dt.pixelMarginRight() && oe.test(s) && re.test(e) && (n = a.width,
          r = a.minWidth,
          o = a.maxWidth,
    ...
    function L(t) {
      var e = ft.cssProps[t];
      return e || (e = ft.cssProps[t] = k(t) || t),
        e
    }
    ...
    function Q(t, e, i, n, r) {
      ...
      for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2)
        ...
        n ? ("content" === i && (s -= ft.css(t, "padding" + Wt[o], !0, r)),
          "margin" !== i && (s -= ft.css(t, "border" + Wt[o] + "Width", !0, r))) : (s += ft.css(t, "padding" + Wt[o], !0, r),
          "padding" !== i && (s += ft.css(t, "border" + Wt[o] + "Width", !0, r)));
      return s
    }
    ...
    function R(t, e, i) {
      ...
      return oe.test(o) ? o : (n = s && (dt.boxSizingReliable() || o === t.style[e]),
        "auto" === o && (o = t["offset" + e[0].toUpperCase() + e.slice(1)]),
        (o = parseFloat(o) || 0) + Q(t, e, i || (s ? "border" : "content"), n, r) + "px")
    }
    ...
    function W() {
      fe && (!1 === et.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(W) : t.setTimeout(W, ft.fx.interval),
        ft.fx.tick())
    }
    ...
    function V(t, e, i) {
      var n, r, o = 0,
        ...
        l = function () {
          if (r)
            return !1;
          for (var e = pe || M(), i = Math.max(0, u.startTime + u.duration - e), n = 1 - (i / u.duration || 0), o = 0, s = u.tweens.length; o < s; o++)
            u.tweens[o].run(n);
      ...
      for (B(c, u.opts.specialEasing); o < s; o++)
        if (n = V.prefilters[o].call(u, t, c, u.opts))
          return ft.isFunction(n.stop) && (ft._queueHooks(u.elem, u.opts.queue).stop = ft.proxy(n.stop, n)),
            n;
      return ft.map(c, F, u),
        ...
        for ("boolean" == typeof s && (u = s,
          ...
          if (null != (t = arguments[a]))
            for (e in t)
              i = s[e],
              n = t[e],
              s !== n && (u && n && (ft.isPlainObject(n) || (r = Array.isArray(n))) ? (r ? (r = !1,
                  o = i && Array.isArray(i) ? i : []) : o = i && ft.isPlainObject(i) ? i : {},
                s[e] = ft.extend(u, o, n)) : void 0 !== n && (s[e] = n));
        return s
      },
      ft.extend({
        ...
        makeArray: function (t, e) {
          var i = e || [];
          return null != t && (n(Object(t)) ? ft.merge(i, "string" == typeof t ? [t] : t) : ot.call(i, t)),
            i
        },
    ...
    var _t = function (t) {
      function e(t, e, i, n) {
        ...
        if (i = i || [],
          ...
          return i;
        if (!n && ((e ? e.ownerDocument || e : z) !== O && D(e),
            e = e || O,
            Y)) {
          if (11 !== f && (l = gt.exec(t)))
            if (r = l[1]) {
              if (9 === f) {
                ...
                if (s.id === r)
                  return i.push(s),
                    i
              } else if (p && (s = p.getElementById(r)) && Q(e, s) && s.id === r)
                return i.push(s),
                  i
            } else {
              if (l[2])
          ...
          if (b.qsa && !B[t + " "] && (!k || !k.test(t))) {
            if (1 !== f)
              ...
              for ((a = e.getAttribute("id")) ? a = a.replace(_t, bt) : e.setAttribute("id", a = R),
                o = (c = E(t)).length; o--;)
                c[o] = "#" + a + " " + h(c[o]);
              d = c.join(","),
            ...
            if (d)
              try {
                return K.apply(i, p.querySelectorAll(d)),
                  i
              } catch (t) {} finally {
          ...
          n(function (n, s, a, l) {
            ...
            if (n) {
              if (o || t) {
                ...
                for (c = _.length; c--;)
                  (h = _[c]) && (u = o ? Z(n, h) : d[c]) > -1 && (n[u] = !(s[u] = h))
              }
            } else
              _ = g(_ === s ? _.splice(m, _.length) : _),
      ...
      b = e.support = {},
        ...
        D = e.setDocument = function (t) {
          ...
          return n !== O && 9 === n.nodeType && n.documentElement ? (O = n,
            j = O.documentElement,
            Y = !C(O),
            z !== O && (i = O.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", Tt, !1) : i.attachEvent && i.attachEvent("onunload", Tt)),
            ...
            L = [],
            k = [],
            (b.qsa = ft.test(O.querySelectorAll)) && (r(function (t) {
                j.appendChild(t).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                  t.querySelectorAll("[msallowcapture^='']").length && k.push("[*^$]=" + tt + "*(?:''|\"\")"),
                  t.querySelectorAll("[selected]").length || k.push("\\[" + tt + "*(?:value|" + J + ")"),
                  t.querySelectorAll("[id~=" + R + "-]").length || k.push("~="),
                  t.querySelectorAll(":checked").length || k.push(":checked"),
                  t.querySelectorAll("a#" + R + "+*").length || k.push(".#.+[+~]")
              }),
              r(function (t) {
                ...
                e.setAttribute("type", "hidden"),
                  ...
                  t.querySelectorAll("[name=d]").length && k.push("name" + tt + "*[*^$|!~]?="),
            ...
            Q = e || ft.test(j.contains) ? function (t, e) {
            ...
            V = e ? function (t, e) {
              ...
              return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1,
                1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === O || t.ownerDocument === z && Q(z, t) ? -1 : e === O || e.ownerDocument === z && Q(z, e) ? 1 : I ? Z(I, t) - Z(I, e) : 0 : 4 & i ? -1 : 1)
            } :
            function (t, e) {
              if (t === e)
                return A = !0,
              ...
              var i, n = 0,
                ...
                l = [e];
              if (!r || !o)
                return t === O ? -1 : e === O ? 1 : r ? -1 : o ? 1 : I ? Z(I, t) - Z(I, e) : 0;
              if (r === o)
                return s(t, e);
        ...
        e.matchesSelector = function (t, i) {
          if ((t.ownerDocument || t) !== O && D(t),
            i = i.replace(lt, "='$1']"),
            b.matchesSelector && Y && !B[i + " "] && (!L || !L.test(i)) && (!k || !k.test(i)))
            try {
              var n = N.call(t, i);
        ...
        (T = e.selectors = {
          ...
          preFilter: {
            ...
            PSEUDO: function (t) {
              var e, i = !t[6] && t[2];
              return ht.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ut.test(i) && (e = E(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                  t[2] = i.slice(0, e)),
                t.slice(0, 3))
            }
          },
          filter: {
                ...
                function (e, i, l) {
                  ...
                  if (m) {
                    ...
                    if (f = [s ? m.firstChild : m.lastChild],
                      s && v) {
                      for (_ = (p = (u = (c = (h = (d = m)[R] || (d[R] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === W && u[1]) && u[2],
                        d = p && m.childNodes[p]; d = ++p && d && d[g] || (_ = p = 0) || f.pop();)
                        ...
                        _ = p), !1 === _)
                      for (;
                        (d = ++p && d && d[g] || (_ = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++_ || (v && (h = d[R] || (d[R] = {}),
                            c = h[d.uniqueID] || (h[d.uniqueID] = {}),
                            c[t] = [W, _]),
                          d !== e));)
                    ;
            ...
            PSEUDO: function (t, i) {
              ...
              return o[R] ? o(i) : o.length > 1 ? (r = [t, t, "", i],
            ...
            lang: n(function (t) {
              return ct.test(t || "") || e.error("unsupported lang: " + t),
                ...
                function (e) {
                  var i;
                  do {
                    if (i = Y ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
      ...
      return c.prototype = T.filters = T.pseudos,
        ...
        E = e.tokenize = function (t, i) {
          ...
          for (a = t,
            l = [],
            u = T.preFilter; a;) {
            n && !(r = st.exec(a)) || (r && (a = a.slice(r[0].length) || a),
                l.push(o = [])),
              n = !1,
              (r = at.exec(a)) && (n = r.shift(),
                o.push({
                  value: n,
                  type: r[0].replace(ot, " ")
                }),
                a = a.slice(n.length));
            for (s in T.filter)
              !(r = ht[s].exec(a)) || u[s] && !(r = u[s](r)) || (n = r.shift(),
                o.push({
                  value: n,
                  type: s,
                  matches: r
        ...
        P = e.select = function (t, e, i, n) {
          ...
          if (i = i || [],
            ...
            if ((o = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && 9 === e.nodeType && Y && T.relative[o[1].type]) {
              if (!(e = (T.find.ID(s.matches[0].replace(yt, vt), e) || [])[0]))
                return i;
              c && (e = e.parentNode),
          ...
          return (c || x(t, d))(n, e, !Y, i, !e || mt.test(t) && u(e.parentNode) || e),
            i
        },
    ...
    (ft.fn.init = function (t, e, i) {
      ...
      if (i = i || xt,
        "string" == typeof t) {
        if (!(n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : Pt.exec(t)) || !n[1] && e)
        ...
        return (r = et.getElementById(n[2])) && (this[0] = r,
            this.length = 1),
          this
      }
      return t.nodeType ? (this[0] = t,
        this.length = 1,
        this) : ft.isFunction(t) ? void 0 !== i.ready ? i.ready(t) : t(ft) : ft.makeArray(t, this)
    }).prototype = ft.fn,
      xt = ft(et);
      ...
      ft.each({
        ...
        ft.fn[t] = function (i, n) {
          ...
          return "Until" !== t.slice(-5) && (n = i),
            ...
            this.length > 1 && (It[t] || ft.uniqueSort(r),
              St.test(t) && r.reverse()),
            this.pushStack(r)
        }
      });
    ...
    ft.Callbacks = function (t) {
      ...
      ft.extend({
            ...
            r = {
              ...
              then: function (e, n, r) {
                      ...
                      h = function () {
                        ...
                        if (!(e < s)) {
                          ...
                          h = t && ("object" == typeof t || "function" == typeof t) && t.then,
                            ft.isFunction(h) ? r ? h.call(t, o(s, i, l, r), o(s, i, u, r)) : (s++,
                              h.call(t, o(s, i, l, r), o(s, i, u, r), o(s, i, l, i.notifyWith))) : (n !== l && (a = void 0,
                                c = [t]),
                              (r || i.resolveWith)(a, c))
                        }
                      },
                ...
                return ft.Deferred(function (t) {
                  i[0][3].add(o(0, t, ft.isFunction(r) ? r : l, t.notifyWith)),
        ...
        when: function (t) {
          ...
          if (e <= 1 && (c(t, o.done(s(i)).resolve, o.reject, !e),
    ...
    d.uid = 1,
      d.prototype = {
        cache: function (t) {
          ...
          return e || (e = {},
              Yt(t) && (t.nodeType ? t[this.expando] = e : Object.defineProperty(t, this.expando, {
                value: e,
                configurable: !0
              }))),
            e
        ...
        remove: function (t, e) {
          ...
          if (void 0 !== n) {
            if (void 0 !== e) {
              Array.isArray(e) ? e = e.map(ft.camelCase) : (e = ft.camelCase(e),
                  e = e in n ? [e] : e.match(At) || []),
                i = e.length;
              for (; i--;)
                delete n[e[i]]
            }
        ...
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (this.length && (r = Lt.get(o),
              ...
              for (i = s.length; i--;)
                s[i] && 0 === (n = s[i].name).indexOf("data-") && (n = ft.camelCase(n.slice(5)),
                  f(o, n, r[n]));
      ...
      ft.extend({
        queue: function (t, e, i) {
          ...
          if (t)
            return e = (e || "fx") + "queue",
              n = kt.get(t, e),
              i && (!n || Array.isArray(i) ? n = kt.access(t, e, ft.makeArray(i)) : n.push(i)),
              n || []
        },
      ...
      ft.fn.extend({
        ...
        promise: function (t, e) {
          ...
          for ("string" != typeof t && (e = t,
              t = void 0),
            t = t || "fx"; s--;)
            (i = kt.get(o[s], t + "queueHooks")) && i.empty && (n++,
              i.empty.add(a));
          return a(),
            r.promise(e)
        }
        ...
        add: function (t, e, i, n, r) {
          ...
          if (m)
            for (i.handler && (o = i,
              ...
              u = (e = (e || "").match(At) || [""]).length; u--;)
              a = Zt.exec(e[u]) || [],
              p = g = a[1],
              f = (a[2] || "").split(".").sort(),
              p && (h = ft.event.special[p] || {},
                ...
                (d = l[p]) || (d = l[p] = [],
                  d.delegateCount = 0,
                  h.setup && !1 !== h.setup.call(t, n, f, s) || t.addEventListener && t.addEventListener(p, s)),
            ...
            for (u = (e = (e || "").match(At) || [""]).length; u--;)
              if (a = Zt.exec(e[u]) || [],
                ...
                for (h = ft.event.special[p] || {},
                  ...
                  s = o = d.length; o--;)
                  c = d[o], !r && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1),
                    c.selector && d.delegateCount--,
                    h.remove && h.remove.call(t, c));
                s && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, m.handle) || ft.removeEvent(t, p, m.handle),
                  delete l[p])
              } else
                for (p in l)
                  ft.event.remove(t, p + e[u], i, n, !0);
            ...
            for (s = ft.event.handlers.call(this, a, u),
              ...
              for (a.currentTarget = r.elem,
                ...
                a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o,
                  a.data = o.data,
                  void 0 !== (n = ((ft.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                    a.stopPropagation()));
            ...
            for (; u !== this; u = u.parentNode || this)
              if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                for (o = [],
                  ...
                  n = e[i],
                  r = n.selector + " ",
                  void 0 === s[r] && (s[r] = n.needsContext ? ft(r, this).index(u) > -1 : ft.find(r, this, null, [u]).length),
                  s[r] && o.push(n);
                o.length && a.push({
                  elem: u,
                  handlers: o
        ...
        ft.event.special[t] = {
          ...
          handle: function (t) {
            var i, n = this,
              r = t.relatedTarget,
              o = t.handleObj;
            return r && (r === n || ft.contains(n, r)) || (t.type = o.origType,
        ...
        off: function (t, e, i) {
          ...
          if (t && t.preventDefault && t.handleObj)
            return n = t.handleObj,
              ft(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
              this;
          if ("object" == typeof t) {
            for (r in t)
              this.off(r, e, t[r]);
        ...
        clone: function (t, e, i) {
          ...
          if (e)
            if (i)
              ...
              I(t, a);
          return (s = v(a, "script")).length > 0 && _(s, !l && v(t, "script")),
            a
        },
        ...
        html: function (t) {
          return jt(this, function (t) {
            ...
            if ("string" == typeof t && !te.test(t) && !qt[(Vt.exec(t) || ["", ""])[1].toLowerCase()]) {
              ...
              try {
                for (; i < n; i++)
                  1 === (e = this[i] || {}).nodeType && (ft.cleanData(v(e, !1)),
                    e.innerHTML = t);
                e = 0
              } catch (t) {}
            }
    ...
    ft.extend({
        ...
        style: function (t, e, i, n) {
          if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
            ...
            return l || (e = L(a)),
              ...
              void 0 === i ? s && "get" in s && void 0 !== (r = s.get(t, !1, n)) ? r : u[e] : ("string" === (o = typeof i) && (r = zt.exec(i)) && r[1] && (i = g(t, e, r),
                  o = "number"),
                void(null != i && i === i && ("number" === o && (i += r && r[3] || (ft.cssNumber[a] ? "" : "px")),
                  dt.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (u[e] = "inherit"),
                  s && "set" in s && void 0 === (i = s.set(t, i, n)) || (l ? u.setProperty(e, i) : u[e] = i))))
          }
        },
        css: function (t, e, i, n) {
          var r, o, s, a = ft.camelCase(e);
          return le.test(e) || (e = L(a)),
            (s = ft.cssHooks[e] || ft.cssHooks[a]) && "get" in s && (r = s.get(t, !0, i)),
            void 0 === r && (r = j(t, e, n)),
      ...
      ft.each(["height", "width"], function (t, e) {
        ft.cssHooks[e] = {
          get: function (t, i, n) {
            if (i)
              return !ae.test(ft.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? R(t, e, n) : Ht(t, ue, function () {
                return R(t, e, n)
              })
          },
          set: function (t, i, n) {
            ...
            return s && (r = zt.exec(i)) && "px" !== (r[3] || "px") && (t.style[e] = i,
                i = ft.css(t, e)),
              N(t, i, s)
          }
        }
    ...
    ft.Animation = ft.extend(V, {
        ...
        prefilters: [function (t, e, i) {
          var n, r, o, s, a, l, u, c, h = "width" in e || "height" in e,
            ...
            g = t.nodeType && Mt(t),
            m = kt.get(t, "fxshow");
          i.queue || (null == (s = ft._queueHooks(t, "fx")).unqueued && (s.unqueued = 0,
              a = s.empty.fire,
          ...
          if ((l = !ft.isEmptyObject(e)) || !ft.isEmptyObject(p)) {
            h && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY],
                null == (u = m && m.display) && (u = kt.get(t, "display")),
                "none" === (c = ft.css(t, "display")) && (u ? c = u : (y([t], !0),
                  u = t.style.display || u,
                  c = ft.css(t, "display"),
                  y([t]))),
                ("inline" === c || "inline-block" === c && null != u) && "none" === ft.css(t, "float") && (l || (d.done(function () {
                      f.display = u
                    }),
                    null == u && (c = f.display,
                      u = "none" === c ? "" : c)),
              ...
              l = !1;
            for (n in p)
              l || (m ? "hidden" in m && (g = m.hidden) : m = kt.access(t, "fxshow", {
                  display: u
                }),
                o && (m.hidden = !g),
                g && y([t], !0),
      ...
      ft.speed = function (t, e, i) {
        ...
        return ft.fx.off ? n.duration = 0 : "number" != typeof n.duration && (n.duration in ft.fx.speeds ? n.duration = ft.fx.speeds[n.duration] : n.duration = ft.fx.speeds._default),
    ...
    ft.fn.extend({
      ...
      ft.extend({
        attr: function (t, e, i) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return void 0 === t.getAttribute ? ft.prop(t, e, i) : (1 === o && ft.isXMLDoc(t) || (r = ft.attrHooks[e.toLowerCase()] || (ft.expr.match.bool.test(e) ? ye : void 0)),
              void 0 !== i ? null === i ? void ft.removeAttr(t, e) : r && "set" in r && void 0 !== (n = r.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : r && "get" in r && null !== (n = r.get(t, e)) ? n : (n = ft.find.attr(t, e),
                null == n ? void 0 : n))
        },
        attrHooks: {
          type: {
      ...
      ye = {
        set: function (t, e, i) {
          return !1 === e ? ft.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
      },
        ...
        toggleClass: function (t, e) {
          ...
          return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function (i) {
            ...
            if ("string" === i)
              ...
              void 0 !== t && "boolean" !== i || ((e = q(this)) && kt.set(this, "__className__", e),
                this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : kt.get(this, "__className__") || ""))
          })
        },
        hasClass: function (t) {
          var e, i, n = 0;
    ...
    ft.fn.extend({
        val: function (t) {
          var e, i, n, r = this[0];
          return arguments.length ? (n = ft.isFunction(t),
            this.each(function (i) {
              var r;
              1 === this.nodeType && (r = n ? t.call(this, i, ft(this).val()) : t,
                null == r ? r = "" : "number" == typeof r ? r += "" : Array.isArray(r) && (r = ft.map(r, function (t) {
                  return null == t ? "" : t + ""
                })),
                (e = ft.valHooks[this.type] || ft.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, r, "value") || (this.value = r))
            })) : r ? (e = ft.valHooks[r.type] || ft.valHooks[r.nodeName.toLowerCase()],
          ...
          select: {
            ...
            set: function (t, e) {
              for (var i, n, r = t.options, o = ft.makeArray(e), s = r.length; s--;)
                n = r[s],
                (n.selected = ft.inArray(ft.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    ft.extend(ft.event, {
        trigger: function (e, i, n, r) {
          ...
          if (s = a = n = n || et,
            3 !== n.nodeType && 8 !== n.nodeType && !we.test(p + ft.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."),
                p = f.shift(),
                f.sort()),
              u = p.indexOf(":") < 0 && "on" + p,
            ...
            if (!r && !h.noBubble && !ft.isWindow(n)) {
              for (l = h.delegateType || p,
                we.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                d.push(s),
                a = s;
            ...
            for (o = 0;
              ...
              (c = (kt.get(s, "events") || {})[e.type] && kt.get(s, "handle")) && c.apply(s, i),
              (c = u && s[u]) && c.apply && Yt(s) && (e.result = c.apply(s, i), !1 === e.result && e.preventDefault());
            return e.type = p,
              r || e.isDefaultPrevented() || h._default && !1 !== h._default.apply(d.pop(), i) || !Yt(n) || u && ft.isFunction(n[p]) && !ft.isWindow(n) && ((a = n[u]) && (n[u] = null),
      ...
      dt.focusin || ft.each({
        ...
        ft.event.special[e] = {
          ...
          teardown: function () {
            var n = this.ownerDocument || this,
              r = kt.access(n, e) - 1;
            r ? kt.access(n, e, r) : (n.removeEventListener(t, i, !0),
              kt.remove(n, e))
          }
        }
      });
        ...
        ajax: function (e, i) {
          function n(e, i, n, a) {
            ...
            c || (c = !0,
              ...
              n && (b = Z(f, C, n)),
              b = J(f, b, C, u),
              u ? (f.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (ft.lastModified[o] = T),
          ...
          if (y.promise(C),
            f.url = ((e || f.url || Ce.href) + "").replace(Ne, Ce.protocol + "//"),
            ...
            try {
              u.href = f.url,
                u.href = u.href,
                f.crossDomain = We.protocol + "//" + We.host != u.protocol + "//" + u.host
            } catch (t) {
              f.crossDomain = !0
            }
          }
          if (f.data && f.processData && "string" != typeof f.data && (f.data = ft.param(f.data, f.traditional)),
            K(Qe, f, i, C),
            c)
            return C;
          (h = ft.event && f.global) && 0 == ft.active++ && ft.event.trigger("ajaxStart"),
            ...
            f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(De, "+")) : (p = f.url.slice(o.length),
              f.data && (o += (xe.test(o) ? "&" : "?") + f.data,
                delete f.data), !1 === f.cache && (o = o.replace(je, "$1"),
                p = (xe.test(o) ? "&" : "?") + "_=" + Ee++ + p),
              f.url = o + p),
            f.ifModified && (ft.lastModified[o] && C.setRequestHeader("If-Modified-Since", ft.lastModified[o]),
            ...
            C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + ze + "; q=0.01" : "") : f.accepts["*"]);
          for (d in f.headers)
              ...
              i = function (t) {
                  return function () {
                    i && (i = n = a.onload = a.onerror = a.onabort = a.onreadystatechange = null,
                      "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Me[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                        binary: a.response
                      } : {
                        text: a.responseText
    ...
    ft.ajaxSetup({
      ...
      ft.ajaxPrefilter("json jsonp", function (e, i, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
          return r = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace(Be, "$1" + r) : !1 !== e.jsonp && (e.url += (xe.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
      ...
      ft.offset = {
        setOffset: function (t, e, i) {
          ...
          "static" === u && (t.style.position = "relative"),
            ...
            o = ft.css(t, "top"),
            l = ft.css(t, "left"),
            ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1 ? (n = c.position(),
              s = n.top,
      ...
      ft.each({
        ...
        ft.fn[t] = function (n) {
          return jt(this, function (t, n, r) {
            var o;
            return ft.isWindow(t) ? o = t : 9 === t.nodeType && (o = t.defaultView),
              void 0 === r ? o ? o[e] : t[n] : void(o ? o.scrollTo(i ? o.pageXOffset : r, i ? r : o.pageYOffset) : t[n] = r)
      ...
      ft.each(["top", "left"], function (t, e) {
        ft.cssHooks[e] = Y(dt.pixelPosition, function (t, i) {
          if (i)
            return i = j(t, e),
              oe.test(i) ? ft(t).position()[e] + "px" : i
        })
      }),
      ft.each({
        Height: "height",
        ...
        ft.each({
          ...
          ft.fn[n] = function (r, o) {
            ...
            return jt(this, function (e, i, r) {
              var o;
              return ft.isWindow(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement,
                Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === r ? ft.css(e, i, a) : ft.style(e, i, r, a)
            }, e, s ? r : void 0, s)
          }
        })
      }),
  ...
  function (t, e) {
    ...
    var x = null,
      ...
      I = function () {
        var t = x;
        t || ((t = document.createElement("div")).setAttribute("data-tether-id", P()),
          c(t.style, {
            top: 0,
            left: 0,
            position: "absolute"
      ...
      var t = null,
        ...
        n = function n() {
          return void 0 !== e && e > 16 ? (e = Math.min(e - 16, 250),
            void(i = setTimeout(n, 250))) : void(void 0 !== t && _() - t < 10 || (null != i && (clearTimeout(i),
              i = null),
            t = _(),
            R(),
            e = _() - t))
          ...
          C(e, [{
            ...
            value: function (t) {
              ...
              if (this.element = s,
                ...
                d(this.element, this.getClass("element")), !1 !== this.options.addTargetClasses && d(this.target, this.getClass("target")), !this.options.attachment)
              ...
              this.targetAttachment = V(this.options.targetAttachment),
                ...
                "scroll-handle" === this.targetModifier ? this.scrollParents = [this.target] : this.scrollParents = o(this.target), !1 !== this.options.enabled && this.enable(i)
            }
          }, {
            key: "getTargetBounds",
            value: function () {
              ...
              if ("scroll-handle" === this.targetModifier) {
                ...
                var r = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - n,
                  ...
                  s = 0;
                408 > r && this.target === document.body && (s = -11e-5 * Math.pow(r, 2) - .00727 * r + 22.58),
                  this.target !== document.body && (o.height = Math.max(o.height, 24));
                var l = this.target.scrollTop / (e.scrollHeight - r);
                return o.top = l * (r - o.height - s) + t.top + parseFloat(i.borderTopWidth),
                  this.target === document.body && (o.height = Math.max(o.height, 24)),
                  o
              }
            }
            ...
            value: function (t, e) {
              ...
              n.forEach(function (t) {
                ...
                D(function () {
                  void 0 !== i._addAttachClasses && (m(i.element, i._addAttachClasses, o), !1 !== i.options.addTargetClasses && m(i.target, i._addAttachClasses, o),
            ...
            value: function () {
              ...
              if (this.enabled) {
                ...
                for (var m = c.left + p.left - d.left, y = c.top + p.top - d.top, v = 0; v < E.modules.length; ++v) {
                  ...
                  if (!1 === _)
                    return !1;
                  void 0 !== _ && "object" == typeof _ && (y = _.top,
                    m = _.left)
                }
                var w = {
                    page: {
                  ...
                  x = C.defaultView,
                  P = void 0;
                return C.body.scrollWidth > x.innerWidth && (P = this.cache("scrollbar-size", u),
                    w.viewport.bottom -= P.height),
                  C.body.scrollHeight > x.innerHeight && (P = this.cache("scrollbar-size", u),
                    w.viewport.right -= P.width),
                  (-1 === ["", "static"].indexOf(C.body.style.position) || -1 === ["", "static"].indexOf(C.body.parentElement.style.position)) && (w.page.bottom = C.body.scrollHeight - y - o,
                  ...
                  void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement && void 0 === this.targetModifier && function () {
                    ...
                    if (["Top", "Left", "Bottom", "Right"].forEach(function (t) {
                      ...
                      w.page.top >= i.top + o.top && w.page.bottom >= i.bottom && w.page.left >= i.left + o.left && w.page.right >= i.right) {
                      var s = e.scrollTop,
                        u = e.scrollLeft;
                      w.offset = {
            ...
            value: function (t) {
              ...
              if (void 0 !== this.element.parentNode) {
                    ...
                    if (!1 !== (void 0 !== e.options.optimizations ? e.options.optimizations.gpu : null)) {
                      ...
                      t.top ? (u.top = 0,
                        ...
                        t.left ? (u.left = 0,
                          r = i.left) : (u.right = 0,
                          r = -i.right),
                        u[N] = "translateX(" + Math.round(r) + "px) translateY(" + Math.round(n) + "px)",
                ...
                if ((i.page.top || i.page.bottom) && (i.page.left || i.page.right) ? (u.position = "absolute",
                    h(i.page, t.page)) : (i.viewport.top || i.viewport.bottom) && (i.viewport.left || i.viewport.right) ? (u.position = "fixed",
                    h(i.viewport, t.viewport)) : void 0 !== i.offset && i.offset.top && i.offset.left ? function () {
                    u.position = "absolute";
      ...
      position: function (t) {
        ...
        return this.options.constraints.forEach(function (t) {
            ...
            if (a.indexOf(" ") >= 0) {
              ...
              c = h = a;
            var _ = w(e, o);
            ("target" === h || "both" === h) && (i < _[1] && "top" === y.top && (i += d,
                y.top = "bottom"),
              i + s > _[3] && "bottom" === y.top && (i -= d,
                y.top = "top")),
            "together" === h && ("top" === y.top && ("bottom" === v.top && i < _[1] ? (i += d,
                  y.top = "bottom",
                  i += s,
                  v.top = "top") : "top" === v.top && i + s > _[3] && i - (s - d) >= _[1] && (i -= s - d,
                  y.top = "bottom",
                  v.top = "bottom")),
                "bottom" === y.top && ("top" === v.top && i + s > _[3] ? (i -= d,
                  y.top = "top",
                  i -= s,
                  v.top = "bottom") : "bottom" === v.top && i < _[1] && i + (2 * s - d) <= _[3] && (i += s - d,
                  y.top = "top",
                  v.top = "top")),
                "middle" === y.top && (i + s > _[3] && "top" === v.top ? (i -= s,
                  v.top = "bottom") : i < _[1] && "bottom" === v.top && (i += s,
                  v.top = "top"))),
              ("target" === c || "both" === c) && (n < _[0] && "left" === y.left && (n += p,
                  y.left = "right"),
                n + l > _[2] && "right" === y.left && (n -= p,
                  y.left = "left")),
              "together" === c && (n < _[0] && "left" === y.left ? "right" === v.left ? (n += p,
                y.left = "right",
                n += l,
                v.left = "left") : "left" === v.left && (n += p,
                y.left = "right",
                n -= l,
                v.left = "right") : n + l > _[2] && "right" === y.left ? "left" === v.left ? (n -= p,
                y.left = "left",
                n -= l,
                v.left = "right") : "right" === v.left && (n -= p,
                y.left = "left",
                n += l,
                v.left = "left") : "center" === y.left && (n + l > _[2] && "left" === v.left ? (n -= l,
                v.left = "right") : n < _[0] && "right" === v.left && (n += l,
                v.left = "left"))),
              ("element" === h || "both" === h) && (i < _[1] && "bottom" === v.top && (i += s,
                  v.top = "top"),
                i + s > _[3] && "top" === v.top && (i -= s,
                  v.top = "bottom")),
              ("element" === c || "both" === c) && (n < _[0] && ("right" === v.left ? (n += l,
                  v.left = "left") : "center" === v.left && (n += l / 2,
                  v.left = "left")),
                n + l > _[2] && ("left" === v.left ? (n -= l,
                  v.left = "right") : "center" === v.left && (n -= l / 2,
                  v.left = "right"))),
            ...
            var b = [],
              T = [];
            i < _[1] && (u.indexOf("top") >= 0 ? (i = _[1],
                b.push("top")) : T.push("top")),
              i + s > _[3] && (u.indexOf("bottom") >= 0 ? (i = _[3] - s,
                b.push("bottom")) : T.push("bottom")),
              n < _[0] && (u.indexOf("left") >= 0 ? (n = _[0],
                b.push("left")) : T.push("left")),
              n + l > _[2] && (u.indexOf("right") >= 0 ? (n = _[2] - l,
              ...
              (b.indexOf("left") >= 0 || b.indexOf("right") >= 0) && (v.left = y.left = !1),
              (b.indexOf("top") >= 0 || b.indexOf("bottom") >= 0) && (v.top = y.top = !1),
              (y.top !== r.top || y.left !== r.left || v.top !== e.attachment.top || v.left !== e.attachment.left) && (e.updateAttachClasses(v, y),
                e.trigger("update", {
                  attachment: v,
                  targetAttachment: y
                }))
...
function () {
  ...
  var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
    ...
    s = (function (t) {
          ...
          h = function () {
            ...
            return e.prototype.close = function (t) {
              ...
              e.prototype._removeElement = function (e) {
                var i = this;
                return t(e).removeClass(c.SHOW),
                  o.supportsTransitionEnd() && t(e).hasClass(c.FADE) ? void t(e).one(o.TRANSITION_END, function (t) {
        ...
        t(document).on(u.CLICK_DATA_API, l.DISMISS, h._handleDismiss(new h)),
      ...
      function (t) {
        ...
        t(document).on(c.CLICK_DATA_API, u.DATA_TOGGLE_CARROT, function (e) {
            e.preventDefault();
            var i = e.target;
            t(i).hasClass(l.BUTTON) || (i = t(i).closest(u.BUTTON)),
          ...
          m = function () {
            ...
            return l.prototype.next = function () {
              ...
              l.prototype.pause = function (e) {
                e || (this._isPaused = !0),
                  t(this._element).find(g.NEXT_PREV)[0] && o.supportsTransitionEnd() && (o.triggerTransitionEnd(this._element),
                    this.cycle(!0)),
              ...
              l.prototype._getItemIndex = function (e) {
                return this._items = t.makeArray(t(e).parent().find(g.ITEM)),
              ...
              l.prototype._slide = function (e, i) {
                var n = this,
                  ...
                  u = void 0,
                  c = void 0;
                if (e === d.NEXT ? (l = f.LEFT,
                    u = f.NEXT,
                    c = d.LEFT) : (l = f.RIGHT,
                    u = f.PREV,
                    c = d.RIGHT),
                  s && t(s).hasClass(f.ACTIVE))
                  this._isSliding = !1;
                  ...
                  o.supportsTransitionEnd() && t(this._element).hasClass(f.SLIDE) ? (t(s).addClass(u),
                      o.reflow(s),
                      t(r).addClass(l),
                      t(s).addClass(l),
                      t(r).one(o.TRANSITION_END, function () {
                        t(s).removeClass(l + " " + u).addClass(f.ACTIVE),
                          t(r).removeClass(f.ACTIVE + " " + u + " " + l),
                          n._isSliding = !1,
                          setTimeout(function () {
                            return t(n._element).trigger(h)
                          }, 0)
                      }).emulateTransitionEnd(600)) : (t(r).removeClass(f.ACTIVE),
              ...
              a.prototype.hide = function () {
                ...
                if (t(this._element).hasClass(d.SHOW)) {
                  ...
                  if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
                    ...
                    var s = function () {
                      e.setTransitioning(!1),
                        t(e._element).removeClass(d.COLLAPSING).addClass(d.COLLAPSE).trigger(h.HIDDEN)
                    };
          ...
          d = function () {
            ...
            return e.prototype.toggle = function () {
                ...
                var o = {
                  ...
                  s = t.Event(u.SHOW, o);
                return t(i).trigger(s), !s.isDefaultPrevented() && (this.focus(),
                  this.setAttribute("aria-expanded", !0),
                  t(i).toggleClass(c.SHOW),
                  t(i).trigger(t.Event(u.SHOWN, o)), !1)
              },
              e.prototype.dispose = function () {
                t.removeData(this._element, n),
                    ...
                    if (t(s).hasClass(c.SHOW) && !(i && ("click" === i.type && /input|textarea/i.test(i.target.tagName) || "focusin" === i.type) && t.contains(s, i.target))) {
                      ...
                      t(s).trigger(l),
                        l.isDefaultPrevented() || (r[o].setAttribute("aria-expanded", "false"),
                          t(s).removeClass(c.SHOW).trigger(t.Event(u.HIDDEN, a)))
                    }
                  }
                }
              },
              ...
              e._dataApiKeydownHandler = function (i) {
                if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName) && (i.preventDefault(),
                    i.stopPropagation(), !this.disabled && !t(this).hasClass(c.DISABLED))) {
              ...
              l.prototype.show = function (e) {
                ...
                t(this._element).trigger(n),
                  this._isShown || n.isDefaultPrevented() || (this._isShown = !0,
                    ...
                    t(this._element).on(h.CLICK_DISMISS, p.DATA_DISMISS, function (t) {
                      return i.hide(t)
                    }),
              ...
              l.prototype.hide = function (e) {
                ...
                t(this._element).trigger(r),
                  this._isShown && !r.isDefaultPrevented() && (this._isShown = !1,
                    ...
                    n ? t(this._element).one(o.TRANSITION_END, function (t) {
              ...
              l.prototype._showBackdrop = function (e) {
                ...
                if (this._isShown && this._config.backdrop) {
                  ...
                  if (this._backdrop = document.createElement("div"),
                    ...
                    t(this._backdrop).addClass(d.SHOW), !e)
                    return;
                  if (!r)
                    return void e();
          ...
          g = function () {
            ...
            return l.prototype.refresh = function () {
              ...
              l.prototype._getConfig = function (i) {
                ...
                return o.typeCheckConfig(e, i, c),
                  i
              },
          ...
          h = function () {
            ...
            return e.prototype.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(u.ACTIVE) || t(this._element).hasClass(u.DISABLED))) {
                  ...
                  r && (n = t.makeArray(t(r).find(c.ACTIVE)),
                    n = n[n.length - 1]);
                  ...
                  if (n && t(n).trigger(a),
                    t(this._element).trigger(h), !h.isDefaultPrevented() && !a.isDefaultPrevented()) {
                    s && (i = t(s)[0]),
              ...
              e.prototype._activate = function (e, i, n) {
                ...
                s && a ? t(s).one(o.TRANSITION_END, l).emulateTransitionEnd(150) : l(),
            ...
            return l.prototype.enable = function () {
              ...
              l.prototype.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                  ...
                  r.setAttribute("id", s),
                    ...
                    this.setContent(),
                    this.config.animation && t(r).addClass(f.FADE);
                  ...
                  if (o.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE))
                    return this._isTransitioning = !0,
                      void t(this.tip).one(o.TRANSITION_END, h).emulateTransitionEnd(l._TRANSITION_DURATION);
                  h()
                }
              },
              l.prototype.hide = function (e) {
                ...
                if (this._isTransitioning)
                  throw new Error("Tooltip is transitioning");
                var s = function () {
                  i._hoverState !== d.SHOW && n.parentNode && n.parentNode.removeChild(n),
                ...
                t(this.element).trigger(r),
                  r.isDefaultPrevented() || (t(n).removeClass(f.SHOW),
                    this._activeTrigger[y.CLICK] = !1,
                    this._activeTrigger[y.FOCUS] = !1,
                    this._activeTrigger[y.HOVER] = !1,
                    o.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE) ? (this._isTransitioning = !0,
                      t(n).one(o.TRANSITION_END, s).emulateTransitionEnd(150)) : s(),
                    this._hoverState = "")
              },
              ...
              l.prototype._enter = function (e, i) {
                ...
                return (i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()),
                  ...
                  e && (i._activeTrigger["focusin" === e.type ? y.FOCUS : y.HOVER] = !0),
                  t(i.getTipElement()).hasClass(f.SHOW) || i._hoverState === d.SHOW ? void(i._hoverState = d.SHOW) : (clearTimeout(i._timeout),
              ...
              l.prototype._leave = function (e, i) {
                ...
                if ((i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()),
                    t(e.currentTarget).data(n, i)),
                  e && (i._activeTrigger["focusout" === e.type ? y.FOCUS : y.HOVER] = !1), !i._isWithActiveTrigger())
              ...
              l._jQueryInterface = function (e) {
                return this.each(function () {
                  var i = t(this).data(s),
                    r = "object" === (void 0 === e ? "undefined" : n(e)) && e;
                  if ((i || !/dispose|hide/.test(e)) && (i || (i = new l(this, r),
                        t(this).data(s, i)),
                      "string" == typeof e)) {
                    if (void 0 === i[e])
                      throw new Error('No method named "' + e + '"');
        ...
        return e(c, s),
          ...
          c._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if ((e || !/destroy|hide/.test(t)) && (e || (e = new c(this, i),
                    o(this).data(l, e)),
                  "string" == typeof t)) {
                if (void 0 === e[t])
...
function (t, e, i, n) {
  ...
  r.Defaults = {
    ...
    r.prototype.registerEventHandlers = function () {
      t.support.transition && this.$stage.on(t.support.transition.end + ".owl.core", t.proxy(this.onTransitionEnd, this)), !1 !== this.settings.responsive && this.on(e, "resize", this._handlers.onThrottledResize),
    ...
    r.prototype.normalize = function (t, e) {
      ...
      return !this.isNumeric(t) || i < 1 ? t = n : (t < 0 || t >= i + r) && (t = ((t - r / 2) % i + i) % i + r / 2),
        t
    },
    ...
    r.prototype.coordinates = function (e) {
      ...
      return e === n ? t.map(this._coordinates, t.proxy(function (t, e) {
        return this.coordinates(e)
          ...
          i += (this.width() - i + (this._coordinates[o] || 0)) / 2 * r) : i = this._coordinates[o] || 0,
        i = Math.ceil(i))
    },
    ...
    r.prototype.to = function (t, e) {
      ...
      this.settings.loop ? (!this.settings.rewind && Math.abs(r) > s / 2 && (r += -1 * o * s),
          t = i + r,
          (n = ((t - a) % s + s) % s + a) !== t && n - r <= l && n - r > 0 && (i = n - r,
            t = n,
    ...
    r.prototype.destroy = function () {
      this.$element.off(".owl.core"),
        ...
        t(i).off(".owl.core"), !1 !== this.settings.responsive && (e.clearTimeout(this.resizeTimer),
...
function (t, e, i, n) {
  ...
  r.Defaults = {
    ...
    r.prototype.thumbnail = function (e, i) {
      ...
      if (e.wrap('<div class="owl-video-wrapper"' + s + "></div>"),
    ...
    r.prototype.swap = function () {
      if (1 === this.core.settings.items && t.support.animation && t.support.transition) {
        ...
        this.core.current() !== this.previous && (s && (e = this.core.coordinates(this.previous) - this.core.coordinates(this.next),
          ...
          o && r.one(t.support.animation.end, i).addClass("animated owl-animated-in").addClass(o))
      }
    },
  ...
  r.Defaults = {
    ...
    r.prototype.draw = function () {
      ...
      this._controls.$relative.toggleClass("disabled", !i.nav || n),
        i.nav && (this._controls.$previous.toggleClass("disabled", !o && r <= this._core.minimum(!0)),
...
function (t, e) {
  ...
  function i(i, o, a) {
      ...
      return t.each(function (t, l) {
          ...
          if (u) {
            ...
            if (c && "_" != e.charAt(0)) {
              ...
              s(o + " is not a valid method")
          } else
            s(i + " not initialized. Cannot call methods, i.e. " + o)
        }),
        void 0 !== r ? r : t
    }
    ...
    (a = a || e || t.jQuery) && (o.prototype.option || (o.prototype.option = function (t) {
      ...
      a.fn[i] = function (t) {
        return "string" == typeof t ? l(this, t, r.call(arguments, 1)) : (u(this, t),
          this)
      },
      n(a))
  }
...
function (t, e) {
  ...
  function n() {
    if (!u) {
      ...
      n.appendChild(e);
      var s = i(e);
      r.isBoxSizeOuter = o = 200 == t(s.width),
        n.removeChild(e)
    }
  }
  ...
  function r(r) {
    if (n(),
      ...
      if ("none" == s.display)
        return e();
      var u = {};
      u.width = r.offsetWidth,
        u.height = r.offsetHeight;
...
function (t, e) {
  ...
  return i.compatOptions.fitWidth = "isFitWidth",
    ...
    i.prototype._manageStamp = function (t) {
      ...
      for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, u = s; a >= u; u++)
...
! function (jQuery, ytp) {
          ...
          if (a.CSSAIsRunning && a.eventType == u.type)
            ...
            if (a.CSSAIsRunning = !0,
              ...
              "function" == typeof n && (r = n,
                n = "cubic-bezier(0.65,0.03,0.36,0.72)"),
              "string" == typeof e)
            ...
            if (e || (e = jQuery.fx.speeds._default),
              ...
              var h = "",
                d = "transitionEnd";
              jQuery.browser.webkit ? (h = "-webkit-",
                ...
                u = [];
              for (p in t)
                "transform" === (c = p) && (c = h + "transform",
                  t[c] = t[p],
                  delete t[p]),
                "filter" === c && (c = h + "filter",
                  t[c] = t[p],
                  delete t[p]),
                ("transform-origin" === c || "origin" === c) && (c = h + "transform-origin",
                  t[c] = t[p],
                  delete t[p]),
                "x" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                ...
                "z" === c && (c = h + "transform",
                  ...
                  delete t[p]),
                "rotate" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " rotate(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "rotateX" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " rotateX(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "rotateY" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " rotateY(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "rotateZ" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " rotateZ(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "scale" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " scale(" + s(t[p], "") + ")",
                  delete t[p]),
                "scaleX" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " scaleX(" + s(t[p], "") + ")",
                  delete t[p]),
                "scaleY" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " scaleY(" + s(t[p], "") + ")",
                  delete t[p]),
                "scaleZ" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " scaleZ(" + s(t[p], "") + ")",
                  delete t[p]),
                "skew" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " skew(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "skewX" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " skewX(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "skewY" === c && (c = h + "transform",
                  t[c] = t[c] || "",
                  t[c] += " skewY(" + s(t[p], "deg") + ")",
                  delete t[p]),
                "perspective" === c && (c = h + "transform",
                  t[c] = t[c] || "",
  ...
  var getYTPVideoID = function (t) {
    var e, i;
    return t.indexOf("youtu.be") > 0 ? (e = t.substr(t.lastIndexOf("/") + 1, t.length),
      i = e.indexOf("?list=") > 0 ? e.substr(e.lastIndexOf("="), e.length) : null,
      e = i ? e.substr(0, e.lastIndexOf("?")) : e) : t.indexOf("http") > -1 ? (e = t.match(/[\\?&]v=([^&#]*)/)[1],
      i = t.indexOf("list=") > 0 ? t.match(/[\\?&]list=([^&#]*)/)[1] : null) : (e = t.length > 15 ? null : t,
      i = e ? null : t), {
      videoID: e,
      playlistID: i
    }
  ...
  ytp.isDevice = jQuery.browser.mobile,
    jQuery.mbYTPlayer = {
              ...
              YTPlayer.isBackground && ytp.backgroundIsInited || YTPlayer.isInit || (YTPlayer.isBackground && YTPlayer.opt.stopMovieOnClick && jQuery(document).off("mousedown.ytplayer").on("mousedown,.ytplayer", function (t) {
                ...
                jQuery(YTPlayer).on("YTPChanged", function () {
                  return YTPlayer.isInit ? void 0 : (YTPlayer.isInit = !0,
                    ytp.isDevice && !YTPlayer.isBackground ? void new YT.Player(playerID, {
      ...
      getDataFromFeed: function (t) {
        jQuery.browser.msie && jQuery.browser.version < 9 ? ("auto" == t.opt.ratio ? t.opt.ratio = "16/9" : t.opt.ratio,
          t.hasData || (t.hasData = !0,
            ...
            i.prop = {};
            for (var n in t.videoData)
              i.prop[n] = t.videoData[n];
            if (jQuery(t).trigger(i),
              t.title = t.videoData.title,
              "auto" == t.opt.ratio && (t.opt.ratio = t.videoData.aspectRatio && "widescreen" === t.videoData.aspectRatio ? "16/9" : "4/3"), !t.hasData && (t.hasData = !0,
                t.isPlayer)) {
      ...
      playYTP: function () {
        var t = this.get(0);
        void 0 !== t.player && (jQuery("#controlBar_" + t.id).find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.pause),
          t.player.playVideo(),
      ...
      stopYTP: function () {
        var t = this.get(0);
        jQuery("#controlBar_" + t.id).find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play),
          t.player.stopVideo()
      },
      pauseYTP: function () {
        var t = this.get(0);
      ...
      muteYTP: function () {
        ...
        t.player.mute(),
          ...
          jQuery("#controlBar_" + t.id).find(".mb_YTVPMuteUnmute").html(jQuery.mbYTPlayer.controls.unmute),
      ...
      unmuteYTP: function () {
        ...
        t.player.unMute(),
          ...
          jQuery("#controlBar_" + t.id).find(".mb_YTVPMuteUnmute").html(jQuery.mbYTPlayer.controls.mute),
        ...
        clearInterval(t.getState),
          t.getState = setInterval(function () {
            ...
            if (t.player.time = e.currentTime,
              ...
              t.opt.showControls && (e.totalTime ? n.find(".mb_YTVPTime").html(jQuery.mbYTPlayer.formatTime(e.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(e.totalTime)) : n.find(".mb_YTVPTime").html("-- : -- / -- : --")),
              document.hasFocus() ? document.hasFocus() && !t.hasFocus && (t.hasFocus = !0,
              ...
              r.loop ? t.player.seekTo(o, !0) : (t.player.pauseVideo(),
                t.wrapper.CSSAnimate({
                  ...
                  if (e.time = t.player.time,
                    jQuery(t).trigger(e),
                    t.player.seekTo(o, !0), !t.isBackground) {
    ...
    jQuery.fn.toggleVolume = function () {
      var t = this.get(0);
      if (t)
        return t.player.isMuted() ? (jQuery(t).unmuteYTP(), !0) : (jQuery(t).muteYTP(), !1)
    },
    jQuery.fn.optimizeDisplay = function () {
      ...
      s.width = n.width + 24 * n.width / 100,
        s.height = "16/9" == e.ratio ? Math.ceil(9 * n.width / 16) : Math.ceil(3 * n.width / 4),
        s.marginTop = -(s.height - n.height) / 2,
        s.marginLeft = -12 * n.width / 100,
        s.height < n.height && (s.height = n.height + 24 * n.height / 100,
          s.width = "16/9" == e.ratio ? Math.floor(16 * n.height / 9) : Math.floor(4 * n.height / 3),
      ...
      typewrite: function (t, e) {
        if (!0 !== this.stop) {
          ...
          n.timeout = setTimeout(function () {
            ...
            n.timeout = setTimeout(function () {
              if (e === t.length) {
                if (n.options.onStringTyped(n.arrayPos),
                  n.arrayPos === n.strings.length - 1 && (n.options.callback(),
                    n.curLoop++, !1 === n.loop || n.curLoop === n.loopCount))
                  return;
                n.timeout = setTimeout(function () {
                  n.backspace(t, e)
                }, n.backDelay)
      ...
      backspace: function (t, e) {
        if (!0 !== this.stop) {
          ...
          n.timeout = setTimeout(function () {
            ...
            var r = t.substr(0, e);
            n.attr ? n.el.attr(n.attr, r) : n.isInput ? n.el.val(r) : "html" === n.contentType ? n.el.html(r) : n.el.text(r),
              e > n.stopNum ? (e--,
                n.backspace(t, e)) : e <= n.stopNum && (++n.arrayPos === n.strings.length ? (n.arrayPos = 0,
                n.shuffle && (n.sequence = n.shuffleArray(n.sequence)),
                n.init()) : n.typewrite(n.strings[n.sequence[n.arrayPos]], e))
          }, i)
        }
      },
...
function (t) {
  ...
  function e(e) {
    return this.each(function () {
      ...
      (o || "destroy" != e) && (o || i.data("bs.validator", o = new n(this, r)),
        "string" == typeof e && o[e]())
    })
  }
  var i = ':input:not([type="submit"], button):enabled:visible',
    n = function (e, i) {
      ...
      for (var r in i.custom)
        if (!i.errors[r])
          throw new Error("Missing default error message for custom validator: " + r);
  ...
  n.DEFAULTS = {
      ...
      if (i.is('[type="radio"]') && (i = this.$element.find('input[name="' + i.attr("name") + '"]')),
        ...
        this.runValidators(i).done(function (o) {
          i.data("bs.validator.errors", o),
            ...
            n && o.toString() === n.toString() || (e = o.length ? t.Event("invalid.bs.validator", {
                relatedTarget: i[0],
                detail: o
              ...
              r.$element.trigger(e)),
            r.toggleSubmit(),
            r.$element.trigger(t.Event("validated.bs.validator", {
              relatedTarget: i[0]
            }))
        })
      }
    ...
    n.prototype.runValidators = function (e) {
      ...
      return e.data("bs.validator.deferred") && e.data("bs.validator.deferred").reject(),
        ...
        t.each(n.VALIDATORS, t.proxy(function (t, n) {
          ...
          var n = {};
          n[e.attr("name")] = e.val(),
            t.get(e.data("remote"), n).fail(function (t, e, n) {
              r.push(i("remote") || n)
            }).always(function () {
              o.resolve(r)
            })
    ...
    n.prototype.showErrors = function (e) {
      ...
      this.defer(e, function () {
        ...
        s.length && (s = t("<ul/>").addClass("list-unstyled").append(t.map(s, function (e) {
          ...
          void 0 === r.data("bs.validator.originalContent") && r.data("bs.validator.originalContent", r.html()),
          r.empty().append(s),
          n.addClass("has-error"),
          o.length && o.removeClass(this.options.feedback.success) && o.addClass(this.options.feedback.error) && n.removeClass("has-success"))
      })
    },
    n.prototype.clearErrors = function (t) {
      ...
      i.html(i.data("bs.validator.originalContent")),
        ...
        n.length && n.removeClass(this.options.feedback.error) && n.addClass(this.options.feedback.success) && e.addClass("has-success")
    },
    ...
    n.prototype.defer = function (e, i) {
      return i = t.proxy(i, this),
        this.options.delay ? (window.clearTimeout(e.data("bs.validator.timeout")),
          void e.data("bs.validator.timeout", window.setTimeout(i, this.options.delay))) : i()
    },
    n.prototype.destroy = function () {
      return this.$element.removeAttr("novalidate").removeData("bs.validator").off(".bs.validator"),
        this.$element.find(i).off(".bs.validator").removeData(["bs.validator.errors", "bs.validator.deferred"]).each(function () {
          var e = t(this),
...
$("#contactForm").validator().on("submit", function (t) {
  t.isDefaultPrevented() ? (formError(),
    submitMSG(!1, "Did you fill in the form properly?")) : (t.preventDefault(),
    submitForm())
});
